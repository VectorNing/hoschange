var selectedType = -1;
	$('.seatCharts-cell.seatCharts-seat.cell-con').click(function() {
		...
		/*}*/
		if( ( !cell.hasClass('selected')) && $('.seatCharts-cell.seatCharts-seat.cell-con.selected').length==0)
			selectedType = -1;
});
...
/*		var selectCells = $('.seatCharts-cell.seatCharts-seat.cell-con[data-stenumber='+boxnum+'][data-col='+colnum+'][data-state=0]');
	...
	function selectRow(boxnum,rownum){
		var selectCells = $('.seatCharts-cell.seatCharts-seat.cell-con[data-stenumber='
				+ boxnum + '][data-row="'+rownum+'"]');
		selectCells.addClass('selected');
	}
	function unSelectRow(boxnum,rownum){
		var selectCells = $('.seatCharts-cell.seatCharts-seat.cell-con[data-stenumber='+boxnum+'][data-row="'+rownum+'"]');
		selectCells.removeClass('selected');
	...
	/*当row中全选中的时候checkbox打对勾，没有全选中则不打勾*/
	...
	$(function(){
		...
		$('.colSelector>input').change(function(e){
			...
			if($(this).is(':checked')){
				...
				changeAllSelectState(boxnum,0);
				if($('.seatCharts-cell.seatCharts-seat.cell-con').length==0)
					selectedType = -1;
			}
