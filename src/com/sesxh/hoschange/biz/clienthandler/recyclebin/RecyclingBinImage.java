...
@Component
public class RecyclingBinImage extends BaseClientPacketHandler {
	@Autowired
	...
	protected Object bizProcess(Object paraModel) throws BaseException {
		...
		return hosRecycleSelfService.RecyclingBinImage(jsonObject);
	}
	...
	protected void register() throws BaseException {
		this.clientHandlerFactory.register("RecyclingBinImage", this.getClass());
	}
