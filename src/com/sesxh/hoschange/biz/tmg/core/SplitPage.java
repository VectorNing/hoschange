...
public class SplitPage {
	...
	public SplitPage(int count, int pagesize) {
		...
		rowcount = count;
		// 计算页数
		pagecount = ((rowcount % this.pagesize) != 0) ? (rowcount / this.pagesize + 1) : (rowcount / this.pagesize);
	}

	public SplitPage(String clickFuncName) {
	...
	public String getNavBar(String actionName) {
		...
		String clickFunc = this.clickFuncName == null ? "query" : this.clickFuncName;
			...
			if (pagecount == 1) {
				...
				if (this.currentpage >= 1) {
					...
					if (currentpage == 1) {
						...
						html.append("&nbsp;&nbsp;<a href=\"");
						html.append("#");
						html.append("\" onclick='javascript:" + clickFunc + "(" + (1) + ")'>");
						html.append("首页");
						html.append("</a>&nbsp;&nbsp;");

						html.append("<a id=pgup href=\"");
						html.append("#");
						html.append("\" onclick='javascript:" + clickFunc + "(" + (currentpage - 1) + ")'>");
						html.append("上一页");
						html.append("</a>&nbsp;&nbsp;");
					}
				}
				...
				if (this.currentpage <= pagecount) {
					...
					if (currentpage == pagecount) {
						...
						html.append("<a href=\"");
						html.append("#");
						html.append("\" onclick='javascript:" + clickFunc + "(" + (pagecount) + ")'>");
						html.append("末页");
						html.append("</a>&nbsp;");
					}
				}
				...
				html.append(
						"<input type='text' name='gotopagenum' id='gotopagenum' size='2' value='" + currentpage + "'>");
				...
				html.append(" 		" + clickFunc + "(document.getElementById('gotopagenum').value);\n");
				html.append("	} else {\n");
