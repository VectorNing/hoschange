...
public interface HosClothesPressBpo {
	/**
	 * 查询所有衣柜信息
	 * @author xujialong
	 * @param params
	...
	* @throws:
	...
	/**
	 * 领取衣服成功后为其分配衣柜
	* @Title: allotClothesPressContainer
	* @author Ning 
	* @data:2017年1月19日
	* @return:Map<String,Object>
	* @throws:
	 */
	public Map<String, Object>  allotClothesPressContainer(Integer roomNumber,Integer userId,Map<String, Object> map) throws BaseException;
	/**
	 * 根据衣柜id查询衣柜使用情况
	 * @author xujialong
	 * @param id
